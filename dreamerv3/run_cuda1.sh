...
#wait
CUDA_VISIBLE_DEVICES=1 python train.py --configs defaults metaworld --task metaworld_button_press --logdir /data/ytzheng/log_eccv2024/metaworld/metaworld_button_press_s1 --seed 1
wait
CUDA_VISIBLE_DEVICES=1 python train.py --configs defaults metaworld --task metaworld_coffee_push --logdir /data/ytzheng/log_eccv2024/metaworld/metaworld_coffee_push_s1 --seed 1
wait
CUDA_VISIBLE_DEVICES=1 python train.py --configs defaults metaworld --task metaworld_drawer_open --logdir /data/ytzheng/log_eccv2024/metaworld/metaworld_drawer_open_s1 --seed 1
wait
CUDA_VISIBLE_DEVICES=1 python train.py --configs defaults metaworld --task metaworld_window_open --logdir /data/ytzheng/log_eccv2024/metaworld/metaworld_window_open_s1 --seed 1
wait
